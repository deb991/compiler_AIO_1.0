...
desktopTaskBar.configure(background='black')
desktopTaskBar.wm_attributes("-transparentcolor", "black")
desktopTaskBar.overrideredirect(1)
desktopTaskBar.lift()


helv9 = tkinter.font.Font(family='Helvetica', size=9, weight=tkinter.font.BOLD)
...
def Search():
    print('Search')
b = Button ( desktopTaskBar, text="Search", font = helv9, command=Search, padx=8 )
b.place(anchor=SW)
b.pack (side = LEFT)
...
b = Button ( desktopTaskBar, text="OutLook", font = helv9, command=OUTLOOK, padx=6 )
b.place(anchor=SW)
b.pack (side = LEFT)
...
b = Button ( desktopTaskBar, text="Sequal Server", font = helv9, command=MSSequalServer, padx=6)
b.place(anchor=SW)
b.pack (side =LEFT)
...
b = Button ( desktopTaskBar, text="PL/ SQL",font = helv9, command=PLSql, padx=6)
b.place(anchor=SW)
b.pack (side = LEFT)

def BMCControlM():
    print('service start DDF')
b = Button ( desktopTaskBar, text="Control M",font = helv9, command=BMCControlM, padx=6)
b.place(anchor=SW)
b.pack (side = LEFT)

def PyCharmIDE():
    print('service start DDF')
b = Button ( desktopTaskBar, text="PyCharm",font = helv9, command=PyCharmIDE, padx=6)
b.place(anchor=SW)
b.pack (side = LEFT)

def Visual_BasicIDE():
    print('service start DDF')
b = Button ( desktopTaskBar, text="Visual Basic",font = helv9, command=Visual_BasicIDE, padx=6)
b.place(anchor=SW)
b.pack (side = LEFT)
...
b = Button ( desktopTaskBar, text="Exit",font = helv9, command=Exit, padx=3)
b.place(anchor=SW)
b.pack (side = RIGHT)
